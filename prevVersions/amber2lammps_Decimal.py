        ...
        if self.CRD_is_read and self.TOP_is_read:
            ...
            for i in range(self.NATOM):
                ...
                if Shift:
                    ...
                    while z > l.zhi:
                        z = z - self.BOX[2]
                l.Atoms.append([0, self.IAC[i], float(Decimal(self.CHRG[i])/Decimal(18.2223)), \
                                x, y, z]) #Mattia: properly round division of charges by 18.2223 at 4 decimal digits
...
#============================================================
from decimal import * #Mattia: module to round division results properly

getcontext().prec = 4 #Mattia: set Decimal precision to 4 decimal places
